...
public class ChatUtil {
    ...
    private static LegacyComponentSerializer serializer = BukkitComponentSerializer.legacy();
    private static MiniMessage mm = GlenCuboid.getInstance().getMiniMessage();
